...
class ShopBestAdapter(private val context: Context) : RecyclerView.Adapter<ShopBestAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ShopBestAdapter.ViewHolder {
        val binding : ItemShopGoodsBinding = ItemShopGoodsBinding.inflate(LayoutInflater.from(parent.context), parent, false)
        return ViewHolder(binding)
    }

    override fun onBindViewHolder(holder: ShopBestAdapter.ViewHolder, position: Int) {
